...
async def demo_memvid_integration():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Test retrieval
            logger.info(f"🔍 Testing video search...")
            ...
            logger.info(f"🎉 Basic memvid functionality: WORKING!")
    ...
    try:
        ...
        logger.info(f"🎉 Aura+Memvid integration: FULLY WORKING!")
    ...
    try:
        ...
        logger.info(f"🎉 MCP tools integration: WORKING!")
