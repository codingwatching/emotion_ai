...
class ChromaDBRecovery:
    ...
    def backup_current_db(self) -> Path:
    ...
    def create_recovery_report(self, backup_path: Path, extracted_data: dict):
    ...
    def perform_recovery(self):
        ...
        logger.info(f"- Database cleaned and ready for fresh start")
